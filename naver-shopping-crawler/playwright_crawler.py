"""
Playwright Stealth 기반 네이버 스마트스토어 크롤러
...
COOKIE_FILE = '/tmp/naver_playwright_cookies.json'
...
def manual_login():
    """수동 로그인 모드"""
    print("=" * 60)
    print("수동 로그인 모드 (Playwright Stealth)")
    print("=" * 60)
...
def auto_crawl(product_url):
    """자동 크롤링 모드"""
    print("=" * 60)
    print("자동 크롤링 모드 (Playwright Stealth)")
    print("=" * 60)
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if '보안 확인' in content:
                ...
                page.screenshot(path='/tmp/playwright_captcha.png')
                print("   스크린샷: /tmp/playwright_captcha.png")
            ...
            if btn:
                ...
                if '영수증' in content or ('전화번호' in content and '번째' in content):
                    print("\n   ⚠️ 판매자 정보 CAPTCHA 발생!")
                    page.screenshot(path='/tmp/playwright_seller_captcha.png')
                    print("   스크린샷: /tmp/playwright_seller_captcha.png")
            ...
            # 결과 추출
            print("\n결과 추출...")
            page.screenshot(path='/tmp/playwright_result.png')
            content = page.content()
            ...
            print(f"\n스크린샷: /tmp/playwright_result.png")
            print("\n60초 대기 (브라우저 확인)...")
            time.sleep(60)
